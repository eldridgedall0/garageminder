<?php
// ========================================
// GarageMinder Configuration Template
// ========================================
// Copy this file to config.php and update with your actual values
// NEVER commit config.php to Git - it contains sensitive credentials

// ========================================
// DATABASE CONFIGURATION
// ========================================
// Update these with your actual database credentials
const GM_DB_HOST    = 'localhost';              // Usually 'localhost'
const GM_DB_NAME    = 'your_database_name';     // Your database name
const GM_DB_USER    = 'your_database_user';     // Your database username
const GM_DB_PASS    = 'your_database_password'; // Your database password
const GM_DB_CHARSET = 'utf8mb4';                // Keep as utf8mb4
...
const ATTACHMENTS_URL_BASE = '/garage/download.php?id=';  // Update '/garage/' to match your installation path
...
define('GOOGLE_REDIRECT_URI', 'https://yourdomain.com/path/to/google-drive-auth.php');
const GOOGLE_DRIVE_ENABLED = true;
const GOOGLE_CLIENT_ID = 'your-google-client-id.apps.googleusercontent.com';
const GOOGLE_CLIENT_SECRET = 'your-google-client-secret';
const GOOGLE_REDIRECT_URI = 'https://yourdomain.com/path/to/google-drive-auth.php';  // Must match the define() above
...
// WordPress configuration - Update to YOUR WordPress installation path
const WP_PATH = '/home/username/public_html/wordpress';  // Absolute server path to WordPress
...
// ========================================
const CUSTOM_LOGIN_URL = '/login/';        // e.g., '/login/' or '/my-account/'
const CUSTOM_LOGOUT_URL = '/logout/';       // e.g., '/logout/' or leave empty to use wp_logout_url()
